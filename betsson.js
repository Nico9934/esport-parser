...
async function getMatchOdds(nick1, nick2) {
  try {
    ...
    return {
      ...
      url: `${BETSSON_BASE}/apuestas-deportivas/futbol/efootball/batalla-de-efootball-8-minutos-de-juego?tab=liveAndUpcoming&eventId=${ev.id}&eti=0&fs=true`,
...
module.exports = { getMatchOdds, fetchEvents, invalidateCache, debugPrintAll };
